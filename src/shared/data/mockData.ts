...
export const mockEvaluations: Evaluation[] = [
  ...
  // 伊藤優子のCEOセミナー評価
  {
    ...
    firstImpression: '経営理念への理解が深く、真剣に参加している',
    communicationSkills: 'セミナー後の質疑応答での確な質問をしている',
    logicalThinking: '経営課題について論理的に考えている',
    initiative: '積極的にメモを取り、理解を深めようとしている',
    teamwork: '他の参加者との交流も良好',
